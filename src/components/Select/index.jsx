...
const Select = ({ label, options, defaultValue, name, group}) => {
  const [selectedValue, setSelectedValue] = useState(defaultValue)
  return (
     <div className={`w-full h-auto p-4 bg-slate-50 flex justify-between rounded ${group ? 'mt-0' : 'border mt-5'} border-slate-200 font-bold`}>
